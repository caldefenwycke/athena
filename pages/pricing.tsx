...
export default function Pricing() {
  return (
    <div className="max-w-4xl mx-auto p-6 text-white">
      ...
      <ul className="list-disc list-inside space-y-2 mb-10 text-gray-300">
        <li>
          <strong>Option 1:</strong> Pass it on to athletes – The £5 is added at checkout on top of your set registration fee.
        </li>
        <li>
          <strong>Option 2:</strong> Absorb it yourself – You include it within your registration price. Athena deducts £5 per athlete before your payout.
        </li>
      </ul>
      ...
      <p className="text-sm text-gray-400 mt-6 text-center">
        ...
        <Link href="/support" className="underline text-[#00FF00]">
          Support Dashboard
        </Link>{' '}
        for help.
      </p>
