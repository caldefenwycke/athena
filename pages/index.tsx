        ...
        <main className="max-w-6xl mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <div className="max-w-xl mx-auto">
              ...
              <div className="flex justify-center gap-4 mb-4">
                <button onClick={() => setFilter('all')} className={`px-4 py-2 rounded ${filter === 'all' ? 'bg-[#00FF00] text-black' : 'bg-[#222] text-white'}`}>All</button>
                <button onClick={() => setFilter('active')} className={`px-4 py-2 rounded ${filter === 'active' ? 'bg-[#00FF00] text-black' : 'bg-[#222] text-white'}`}>Active</button>
                <button onClick={() => setFilter('completed')} className={`px-4 py-2 rounded ${filter === 'completed' ? 'bg-[#00FF00] text-black' : 'bg-[#222] text-white'}`}>Completed</button>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {competitions.map((competition) => (
              <div key={competition.id} className="bg-[#111] border border-[#222] rounded-lg overflow-hidden hover:border-[#00FF00] transition-colors">
                <div className="p-6">
                  ...
                  <div className="flex justify-between items-center text-sm">
                    ...
                    <span className={`px-3 py-1 rounded text-xs font-medium ${
                      competition.status === 'active' ? 'bg-[#002200] text-[#00FF00]' : 'bg-[#222] text-gray-300'
                    }`}>
