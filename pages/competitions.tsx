...
export default function CompetitionsPage() {
  ...
  const loadCompetitions = async () => {
    ...
    setLoading(true);
    try {
      let competitionsRef = collection(db, 'competitions');
      ...
      q = lastDoc
        ? query(q, startAfter(lastDoc), limit(6))
        : query(q, limit(6));
    ...
    <>
      ...
      <div className="min-h-screen bg-black text-white">
        <main className="max-w-7xl mx-auto px-4 py-12">
          ...
          <h1 className="text-4xl font-bold mb-8 text-white tracking-wide text-center">BROWSE COMPETITIONS</h1>
